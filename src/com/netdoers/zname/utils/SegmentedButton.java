        ...
        for (int i = 0; i < titles.length; i++) {
            ...
            if (titles.length == 1) {
                ...
                if (i == 0) {
                    ...
                    button.setBackgroundDrawable(mBgRightOn);
                } else if (i == titles.length-2) {//ADDED
                    button.setBackgroundDrawable(mBgCenter1On);
                } else {
    ...
    private void handleStateChange(int btnLastIndex, int btnNextIndex) {
        ...
        if (count < 3) {
            ...
            if (btnLastIndex == 0) {
                ...
                btnLast.setBackgroundDrawable(mBgRightOn);
            } else if (btnLastIndex == count-2) {
                btnLast.setBackgroundDrawable(mBgCenter1On);
            }else {
            ...
            if (btnNextIndex == 0) {
                ...
                btnNext.setBackgroundDrawable(mBgRightOff);
            } else if (btnNextIndex == count-2) {
                btnNext.setBackgroundDrawable(mBgCenter1Off);
            } else {
