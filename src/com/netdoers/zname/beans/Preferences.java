...
public class Preferences {
	...
	public String getUserStatus() {
		String flag = sharedPreferences.getString("status", null);
		return flag;
	}

	public void setUserStatusType(String str) {
		editor = sharedPreferences.edit();
		editor.putString("status_type", str);
		editor.commit();
	}

	public String getUserStatusType() {
		String flag = sharedPreferences.getString("status_type", null);
		return flag;
	}
